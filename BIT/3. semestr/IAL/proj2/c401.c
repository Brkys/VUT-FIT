...
**/
	...
	if(*RootPtr == NULL) //Pokud neexistuje žádný uzel
	{
	...
	else if(K < (*RootPtr)->Key) //Prohledávání pravé větve
		BSTInsert(&(*RootPtr)->LPtr, K, Content);
	else if(K > (*RootPtr)->Key) //Prohledávání levé větve
		BSTInsert(&(*RootPtr)->RPtr, K, Content);
	else //Aktualizuje hodnotu v případě nenalezení uzlu
		(*RootPtr)->BSTNodeCont = Content;
}
